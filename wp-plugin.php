...
if (!class_exists('SC_WPPlugin')) {
    abstract class SC_WPPlugin {
        ...
        function SC_WPPlugin($options_name) {
            $args = func_get_args();
            call_user_func_array(array(&$this, "__construct"), $args);
        }
        
        function __construct($options_name) {
            $this->environment = SC_WPPlugin::determine_environment();
            $this->options_name = $options_name;
            
            $this->options = SC_WPPlugin::retrieve_options($this->options_name);
        }
        ...
        static function plugins_directory() {
            if (SC_WPPlugin::determine_environment() == Environment::WordPressMU)
        ...
        static function path_to_plugin_directory() {
            ...
            return SC_WPPlugin::plugins_directory() . "/${current_directory}";
        }
        
        static function url_to_plugin_directory() {
           $current_directory = basename(dirname(__FILE__));
           
           return SC_WPPlugin::plugins_url() . "/${current_directory}";
        }
        ...
        static function path_to_plugin($file_path) {
            ...
            if (SC_WPPlugin::determine_environment() == Environment::WordPressMU)
                return SC_WPPlugin::plugins_directory() . "/${file_name}";
            else
                return SC_WPPlugin::path_to_plugin_directory() . "/${file_name}";
        }
        ...
        static function retrieve_options($options_name) {
            if (SC_WPPlugin::determine_environment() == Environment::WordPressMU || SC_WPPlugin::determine_environment() == Environment::WordPressMS)
